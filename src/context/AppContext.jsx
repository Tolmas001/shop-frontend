...
import { auth, promo, notifications as notifyApi } from '../api';
...
const translations = {
  uz: {
    nav_home: 'Bosh sahifa', nav_shop: 'Do\'kon', nav_categories: 'Kategoriyalar', nav_about: 'Biz haqimizda', nav_contact: 'Aloqa',
    buy_one_click: 'Bir klikda sotib olish',
    one_click_desc: 'Ma\'lumotingizni qoldiring, biz siz bilan bog\'lanamiz.',
    related_products: 'O\'xshash mahsulotlar',
    specifications: 'Xususiyatlari',
    leave_review: 'Fikr qoldirish',
    your_opinion: 'Sizning fikringiz',
    opinion_placeholder: 'Mahsulot haqida fikringiz...',
    upload_image: 'Rasm yuklash',
    no_reviews: 'Hozircha fikrlar yo\'q',
    be_first_review: 'Birinchi bo\'lib fikr qoldiring',
    order_tracking: 'Buyurtmani kuzatish',
    points_balance: 'Sizning balansingiz',
    use_points: 'Bonuslardan foydalanish',
    promo_code: 'Promo-kod',
    apply: 'Qo\'llash',
    back_to_catalog: 'Katalogga qaytish',
    about_us_info: 'Biz haqimizda',
    information_footer: 'Ma\'lumotlar',
    ...
    cat_creams: 'Kremlar', cat_creams_face: 'Yuz kremlari', cat_creams_hand: 'Qo\'l kremlari', cat_creams_body: 'Tana kremlari', cat_sun_protection: 'Quyoshdan himoya kremlari',
    ...
    description: 'Tavsif', information: 'Ma\'lumot', share: 'Ulashish', reviews: 'Sharhlar',
    add_to_cart_success: 'Savatga qo\'shildi!',
    sort_by: 'Saralash', filter_title: 'Filtr', price_range: 'Narx oralig\'i', brand: 'Brend', reset: 'Tozalash',
    loading: 'Yuklanmoqda...', product_not_found: 'Mahsulot topilmadi', back_to_shop: 'Do\'konga qaytish',
    your_opinion_placeholder: 'Mahsulot haqida nima deb o\'ylaysiz?',
    no_reviews_yet: 'Hali sharhlar mavjud emas', be_first_review_text: 'Birinchi bo\'lib fikringizni bildiring!',
    ...
    about_title: 'Bizning do\'konimiz haqida',
    about_desc: 'ShopSRY - bu sifat va innovatsiyalar markazi. Bizning maqsadimiz - mijozlarimizga eng so\'nggi texnologiyalar va eng yuqori sifatli mahsulotlarni hamyonbop narxlarda yetkazib berish.',
    about_quality: 'Yuqori Sifat', about_quality_desc: 'Har bir mahsulot qattiq sifat nazoratidan o\'tadi.',
    about_delivery: 'Tezkor Yetkazib berish', about_delivery_desc: 'O\'zbekiston bo\'ylab eng qisqa muddatlarda yetkazib beramiz.',
    about_support: '24/7 Qo\'llab-quvvatlash', about_support_desc: 'Mutaxassislarimiz har qanday savolingizga javob berishga tayyor.',
  },
  ru: {
    ...
    cat_creams: 'Кремы', cat_creams_face: 'Кремы для лица', cat_creams_hand: 'Кремы для рук', cat_creams_body: 'Кремы для тела', cat_sun_protection: 'Солнцезащитные кремы',
    ...
    description: 'Описание', information: 'Информация', share: 'Поделиться', reviews: 'Отзывы',
    add_to_cart_success: 'Добавлено в корзину!',
    sort_by: 'Сортировка', filter_title: 'Фильтр', price_range: 'Диапазон цен', brand: 'Бренд', reset: 'Сбросить',
    loading: 'Загрузка...', product_not_found: 'Товар не найден', back_to_shop: 'Вернуться в магазин',
    your_opinion_placeholder: 'Что вы думаете о товаре?',
    no_reviews_yet: 'Отзывов пока нет', be_first_review_text: 'Будьте первым, кто оставит отзыв!',
    ...
    about_title: 'О нашем магазине',
    about_desc: 'ShopSRY - это центр качества и инноваций. Наша цель - предоставлять клиентам новейшие технологии и продукцию высочайшего качества по доступным ценам.',
    about_quality: 'Высокое Качество', about_quality_desc: 'Каждый продукт проходит строгий контроль качества.',
    about_delivery: 'Быстрая Доставка', about_delivery_desc: 'Доставляем по всему Узбекистану в кратчайшие сроки.',
    about_support: '24/7 Поддержка', about_support_desc: 'Наши специалисты готовы ответить на любые ваши вопросы.',
  },
  en: {
    ...
    one_click_desc: 'Leave your details, we will contact you.',
    related_products: 'Related Products',
    specifications: 'Specifications',
    leave_review: 'Leave a review',
    your_opinion: 'Your opinion',
    opinion_placeholder: 'Your opinion about the product...',
    ...
    cat_creams: 'Creams', cat_creams_face: 'Face Creams', cat_creams_hand: 'Hand Creams', cat_creams_body: 'Body Creams', cat_sun_protection: 'Sun Protection Creams',
    ...
    about_desc: 'ShopSRY is a center of quality and innovation. Our goal is to provide customers with the latest technology and top-quality products at affordable prices.',
    about_quality: 'High Quality', about_quality_desc: 'Every product undergoes strict quality control.',
    about_delivery: 'Fast Delivery', about_delivery_desc: 'We deliver across Uzbekistan in the shortest possible time.',
    about_support: '24/7 Support', about_support_desc: 'Our specialists are ready to answer any of your questions.',
  }
}
